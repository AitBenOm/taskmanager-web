    ...
    "
      ...
      <span className="px-4 py-1.5 rounded-full
        ...
        space-y-3 text-white hover:border-white/20 transition">
                                ...
                                <p className="text-white/70 text-sm">Tasks
                                    : {group?.tasks?.length + " · Members : " + activeWorkspace?.members?.length}</p>

                                <Link
                                    href={`/dashboard/group/${group.id}`}
                                    className="px-4 py-2 mt-2 w-full rounded-lg bg-white/10
